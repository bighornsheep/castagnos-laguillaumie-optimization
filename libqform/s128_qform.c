...
/*
static inline void mulmod_mixed(s128_t* r, s128_t* a, s128_t* b, s128_t* m, mpz_t az, mpz_t bz, mpz_t mz, int mbits) {
...
// r = (a * b) % m
// mz should be filled out already.  az and bz will be filled out only if needed.
static inline void mulmod_mixed64(s128_t* r, s128_t* a, int64_t b, s128_t* m, mpz_t az, mpz_t bz, mpz_t mz, int mbits) {
...
static void s128_qform_genuine_cube(s128_qform_group_t* group, s128_qform_t* R, const s128_qform_t* A) {
  int64_t a1;
  int64_t b1;
  s128_t c1;
  int64_t SP;
